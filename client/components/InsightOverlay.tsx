      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h3 className="font-semibold text-blue-900 mb-2">AI Strategic Recommendations</h3>
            <p className="text-xs text-blue-700 mb-4">Expert operational strategies generated by AI analysis</p>
              ...
              <div className="space-y-3">
                {aiRecommendations.map((recommendation, index) => {
                  const priorityLabel = index === 0 ? 'HIGH PRIORITY' : 
                                      index === aiRecommendations.length - 1 ? 'SUPPORTING' : 
                                      'MEDIUM PRIORITY';
                  const priorityColor = index === 0 ? 'text-red-600 bg-red-50 border-red-200' : 
                                       index === aiRecommendations.length - 1 ? 'text-gray-600 bg-gray-50 border-gray-200' : 
