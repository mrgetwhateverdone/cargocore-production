  ...
  const kpiCards = [
    {
      ...
      value: `${(kpis.supplierPerformance || 0)}/100`,
    ...
    },
    {
      ...
      value: `${(kpis.shippingCostImpact || 0).toFixed(1)}%`,
      subtitle: "Freight cost trend",
      trend: kpis.shippingCostImpact > 0 ? "up" : kpis.shippingCostImpact < 0 ? "down" : null,
      icon: "🚢",
    },
    {
      title: "Transportation Costs",
      value: `${(kpis.transportationCosts || 0).toFixed(1)}%`,
      subtitle: "Fuel price impact", 
      trend: kpis.transportationCosts > 0 ? "up" : kpis.transportationCosts < 0 ? "down" : null,
      icon: "⛽",
    },
    {
      title: "Supply Chain Health",
      value: `${(kpis.supplyChainHealth || 0)}/100`,
